 ...
 *  GaraLancio che eredita da Gara e implementa IPunteggio e ITempoReazione
 */
public class GaraLancio extends Gara implements IPunteggio,  ITempoReazione{
     ...
     * @param range1 range del minimo (Giavellotto = 50 , Peso= 10, Disco=30)
     * @param range2 range del massimo (Giavellotto = 80, Peso= 18, Disco=55)
     *
     *
     */
    public GaraLancio(ArrayList<Atleta> partecipanti, String nome, int range1, int range2) {
